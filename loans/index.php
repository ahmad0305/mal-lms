                            ...
                            <table id="book-table" class="table table-responsive table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    if($result->num_rows>0){
                                        ...
                                        <td>
                                            <a href="<?php echo BASE_URL ?>loans/edit.php?action=edit&id=<?php echo $row["id"] ?>" class="btn btn-primary btn-sm">Edit</a>
                                            <a onclick="return confirm('Are you Soure?')" href="<?php echo BASE_URL ?>loans?action=delete&id=<?php echo $row["id"] ?>" class="btn btn-danger btn-sm">Delete</a>
