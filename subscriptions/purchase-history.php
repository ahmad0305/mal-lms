...
// Create  suscription functionality
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="book-table" class="table table-responsive table-striped">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo BASE_URL ?>/subscriptions/purchase-history.php">
                            ...
                            <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Slect Plans</label>
                                            <?php $plans =getActivePlans($conn); ?>
